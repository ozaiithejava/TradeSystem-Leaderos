...
public class DefaultLeaderosPattern extends Pattern {
    public static final String NAME = "Standard-LeaderOS";
    ...
    private static final ItemStack COIN = new ItemBuilder(XMaterial.EMERALD).getItem();
